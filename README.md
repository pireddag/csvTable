...
The `csvTable` command takes as its single argument the absolute or relative file path of a csv file and outputs its contents formatted into a wide Tabular environment.
